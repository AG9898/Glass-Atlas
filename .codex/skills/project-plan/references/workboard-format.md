...
- Use the current ID style: `<GROUP>-NN` with optional suffix letter when needed (for example `ADMIN-08A`, `PUBLIC-02B`).
- Keep `group_id` aligned to existing project groups: `SCAFFOLD`, `ADMIN`, `PUBLIC`, `CHAT`, `POLISH`.
