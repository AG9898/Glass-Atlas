...
6. API route runs retrieval — both branches execute in parallel:
   ...
   b. Lexical/topic: title/tags/category ILIKE search via `searchNotesByLexical` (top 10 candidates), also filtered to published notes with current semantic indexes
