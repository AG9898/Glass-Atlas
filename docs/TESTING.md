...
- After chat-quality implementation work, run a live audit sweep with Railway-provided env vars against representative direct, adjacent, and unrelated questions. Record model availability, top retrieved chunks/distances, answer fluidity, quote-copy diagnostics, and low-confidence fallback behavior.
