...
- Assert assistant messages without source metadata do not render an empty source control. (Pending CHAT-06B — no `Chat.svelte` test file exists yet; add this when the source-popup UI ships.)
